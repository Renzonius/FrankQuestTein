...
var closed_set = []
var optimal_way = []
var start_position : Vector2 = Vector2.ZERO # Posicion del npc en el viewport
var end_position : Vector2 = Vector2.ZERO # Posicion del player en el viewport
...
var size_tile : Vector2 # Vector el tamaño de los tiles usados en node_to_pos()
...
func node_to_pos(node_coord: Vector2) -> Vector2:
	return map_to_world(node_coord) + size_tile
